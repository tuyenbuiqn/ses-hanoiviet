<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TourTypeTL.aspx.cs" Inherits="SES.VTTEN.WEB.AdminCP.TourTypeTL" %>
...
<script type="text/javascript">
        function ReturnToParentPage() {
            ...
            parentWindow.SelectAndClosePopup(tlTourCat.GetFocusedNodeKey());
        }
    </script>
<body>
    <form id="form1" runat="server">
<div>
        <dxwtl:ASPxTreeList ID="tlTourType" runat="server" Width="100%" 
            AutoGenerateColumns="False" ClientInstanceName="tlTourCat" 
            KeyFieldName="TourTypeID" ParentFieldName="ParentID">
            <SettingsPager Mode="ShowPager">
            </SettingsPager>
            <SettingsBehavior AllowFocusedNode="True" />
            <Columns>
                <dxwtl:TreeListTextColumn FieldName="TourTypeID" Visible="False" 
                    VisibleIndex="0">
