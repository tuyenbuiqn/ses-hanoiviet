<%@ Page Language="C#" MasterPageFile="~/HanoiViet.Master" AutoEventWireup="true" CodeBehind="AlbumDetail.aspx.cs" Inherits="SES.VTTEN.WEB.AlbumDetail" Title="" %>
                        ...
                        <div class="Album">
                            <div class="Album-Cover">
                                <a class="fancybox-tourimg" rel="tourimg" title='<%#Eval("Title") %>' href='/Media/<%#Eval("Url") %>'>
                                    <img src='/Media/<%#Eval("Url") %>' height="120px" width="180px" title='<%#Eval("Title") %>' alt='<%#Eval("Title")%>' />
                                </a>
                            </div>
                            <div class="Album-Title" style="text-align: center;">
                                <a href='/AlbumDetail/<%#Eval("Url") %>/<%#Change_AV(Eval("Title").ToString()) %>' title='<%#Eval("Title") %>'>
                                    <%#Eval("Title")%>
                                </a>
                            </div>
                        </div>
