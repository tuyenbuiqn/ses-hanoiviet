<%@ Page Language="C#" MasterPageFile="~/HanoiViet.Master" AutoEventWireup="true" CodeBehind="Travel-Guides.aspx.cs" Inherits="SES.VTTEN.WEB.Travel_Guides" Title="Untitled Page" %>
                        ...
                        <div class="tourcatx">
                            <div class="tourcatxy">
                                <div class="tittourcatx">
                                    <h2>
                                        <a style="font-size: 15px; color: #118074" href="/Travel-Guide/<%#Eval("ContentID") %>/<%#FriendlyUrl(Eval("Alias").ToString())%>">
                                            <%#Eval("Title") %></a> 
                                </div>
                            </div>
                            <div class="texttourcatx">
                                <div class="imgtourcatx">
                                    <a href="/Travel-Guide/<%#Eval("ContentID") %>/<%#FriendlyUrl(Eval("Alias").ToString())%>">
                                        <img title="<%#Eval("Title") %>" src="/Media/<%#Eval("ContentImage") %>" width="180px"
                                            height="103px"></a></div>
                                <div class="contenttourcatx">
                                    <div class="contenttourcatx1">
                                        <%#WordCut(Eval("Description").ToString())%><a href="/Travel-Guide/<%#Eval("ContentID") %>/<%#FriendlyUrl(Eval("Alias").ToString())%>"> Read More </a>
                                    </div>
                                    <%--<div class="contenttourcatx2" style="display:none;">
                                        <div class="contenttourcatx3">
                                            From: US $<%#Eval("TourPrice") %> / Pax
                                        </div>
                                        <div class="contenttourcatx4">
                                            <a style="color: #A31D1D" href="#">BOOK THIS TOUR</a>
                                        </div>
                                    </div>--%>
                                </div>
                            </div>
