<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucHotelBooking.ascx.cs" Inherits="SES.VTTEN.WEB.AdminCP.PageUC.ucHotelBooking" %>
<h2>
    Chi tiết đặt khách sạn</h2>
<div class="bookbox">
    <h3 class="booktitle">
        Thông tin khách đặt khách sạn</h3>
    <div class="booktour">
        <div class="book-left">
    ...
    <h3 class="booktitle tour-more">
        Thông tin khách sạn</h3>
    <div class="booktour">
        <div class="book-left">
            <span class="book-lable">Tên khách sạn</span>
