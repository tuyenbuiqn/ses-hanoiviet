<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucListConfig.ascx.cs" Inherits="SES.VTTEN.WEB.AdminCP.PageUC.ucListConfig" %>
...
<asp:GridView ID="gvConfig" runat="server" AutoGenerateColumns="False" BackColor="White"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ConfigCode" HeaderText="Tiêu đề" />
