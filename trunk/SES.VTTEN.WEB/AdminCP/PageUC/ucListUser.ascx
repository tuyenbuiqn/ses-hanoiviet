<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucListUser.ascx.cs" Inherits="SES.VTTEN.WEB.AdminCP.PageUC.ucListUser" %>
        ...
        <td>
            <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="IsSuportOnline" HeaderText="Hỗ trợ viên" />
                    <asp:TemplateField>
                        <ItemTemplate>
