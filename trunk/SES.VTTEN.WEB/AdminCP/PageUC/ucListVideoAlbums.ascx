<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucListVideoAlbums.ascx.cs"
    Inherits="SES.VTTEN.WEB.AdminCP.PageUC.ucListVideoAlbums" %>
<h2>
    Album</h2>
    ...
    <ItemTemplate>
        <center>
            <a class="fancyboxx" rel="group1" title="<%#Eval("Title")%>" href="<%#"/Media/" + (Eval("Url")).ToString() %>">
                <div class="youtube">
                    <iframe src='http://www.youtube.com/embed/<%#Eval("Url")%>' width="200px" height="150px"
                        style="margin: 0px 0px 0px 0px;" frameborder="0" allowfullscreen="true"></iframe>
                </div>
            </a>
            <br />
