<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTourType.ascx.cs"
    Inherits="SES.VTTEN.WEB.AdminCP.PageUC.ucTourType" %>
...
<table width="100%">
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ErrorMessage="Tên danh mục không để trống"
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:CheckBox runat="server" ID="cbkIsInboundTour" />
        </td>
    </tr>
    <tr>
        <td>
