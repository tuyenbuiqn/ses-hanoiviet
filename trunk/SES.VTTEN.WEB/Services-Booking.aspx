<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ListTour.Master" CodeBehind="Services-Booking.aspx.cs" Inherits="SES.VTTEN.WEB.Services_Booking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contentourdt1">
        ...
        <div class="field_book">
            <span class="span_200">Loại dịch vụ:</span>
            <asp:DropDownList CssClass="input_book_180" ID="ddlRoomCat" runat="server">
                <asp:ListItem Value="1">Máy bay</asp:ListItem>
                <asp:ListItem Value="2">Tầu</asp:ListItem>
                <asp:ListItem Value="3">Thuê xe du lịch</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="field_book">
    ...
    <div class="field" style="color: #2c82ad; font-size: 12px; margin: 5px 0; font-weight: bold;">
        THÔNG TIN THÊM</div>
    <div class="field_book">
        <span class="span_120">Ngày khởi hành:</span>
    ...
    <div class="field_book">
        <span class="span_120">Hãng dịch vụ :</span>
