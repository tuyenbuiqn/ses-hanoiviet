<%@ Page Language="C#" MasterPageFile="~/HanoiViet.Master" AutoEventWireup="true" CodeBehind="Videos.aspx.cs" Inherits="SES.VTTEN.WEB.Videos" Title="Videos" %>
                    ...
                    <ItemTemplate>
                        <div class="Album">
                            ...
                            <div class="Album-Title" style="text-align: center;">
                                <a href='/VideoDetail/<%#Eval("AlbumID") %>/<%#Change_AV(Eval("Title").ToString()) %>' title='<%#Eval("Title") %>'>
                                    <%#Eval("Title")%>
                                </a>
                            </div>
                        </div>
